...
from .blue_rl import (BlueEscapeEnv, BlueEscapeEnvConfig, MechanismRewardConfig,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        metavar="SELECTION",
        help=("Reward components reported for the rule policy: all, none, or a comma-separated "
              "subset. The default preserves the existing all-mechanism baseline behavior."),
    )
    parser.add_argument(
...
def evaluate(*, seed_start: int, episodes_per_scenario: int, missile_counts: tuple[int, ...],
    ...
    mechanism_reward = MechanismRewardConfig()
    if reward_mechanisms is not None:
        mechanism_reward = mechanism_reward.with_mechanisms(reward_mechanisms)
    ...
    summary: dict[str, object] = {
        "configuration": {
            ...
            "active_reward_mechanisms": list(mechanism_reward.active_mechanisms()),
        },
